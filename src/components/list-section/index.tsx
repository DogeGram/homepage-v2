...
const listItems = [
  ...
  {
    title: `Open Source`,
    description: `The code is open-source, yay, you can go check it out, tinker with it and add a PR
     or give us some new ideas.`,
    iconjsx: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <section className={tw(`lg:py-28 pt-28 overflow-hidden`)}>
    <div className={tw(`max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 bg-white`)}>
      <div className={tw(`mb-16 text-center`)}>
        <h2 className={tw(`text-base text-indigo-600 font-semibold tracking-wide uppercase`)}>Not created by a </h2>
